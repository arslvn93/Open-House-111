const config = {
  "property": {
    ...
    "heroSubtitle": "Experience the epitome of modern living in this extraordinary 4-bedroom, 4-bathroom Detached. Spanning an impressive 2250 sq ft, this meticulously crafted home offers a perfect blend of style, comfort, and functionality. Every corner has been designed with precision, creating a space that not only meets but exceeds the expectations of discerning homeowners. Discover a residence that seamlessly combines sophisticated design with practical living, where every detail tells a story of quality and thoughtful construction.",
